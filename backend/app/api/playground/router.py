...
<head>
    ...
    <title>WebSocket Playground - Testing Tool</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Real-time Communication Testing Tool</p>
        </div>
            ...
            <div class="left-panel">
                ...
                <div class="section">
                    ...
                    <div class="info-box">
                        ...
                        <p>Login ke aplikasi atau gunakan curl untuk mendapatkan token:</p>
  ...
  -d "username=admin@example.com&password=changethis"</div>
                ...
                <div class="section">
                    ...
                    <div id="messagesTab" class="tab-content">
                        ...
                        <div class="quick-actions" style="margin-top: 20px;">
                            ...
                            <button onclick="sendQuickMessage('test vowels')" class="btn-secondary">Test Bot</button>
                        </div>
                    </div>
                    ...
                    <div id="rawTab" class="tab-content">
                        ...
                        <div class="info-box" style="margin-top: 15px;">
                            ...
                            <div class="code-snippet">{"type": "join_room", "room_name": "test"}</div>
                            <div class="code-snippet">{"type": "message", "content": "Hello!"}</div>
                            <div class="code-snippet">{"type": "list_rooms"}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="messages-container" id="messagesContainer">
                        <div class="message system">
                            ...
                            <div class="message-content">WebSocket Playground initialized. Connect to start testing.</div>
                        </div>
                    </div>
        ...
        <div class="footer">
            <p>WebSocket Playground v1.0 | Full Stack FastAPI Template | Made with ❤️ for Testing</p>
        </div>
    </div>
        ...
        document.getElementById('connectBtn').addEventListener('click', () => {
            ...
            ws.onmessage = (event) => {
                ...
                if (data.startsWith('ROOM_UPDATE:')) {
                    ...
                    currentRoom = roomName === 'None' ? null : roomName;
                    updateCurrentRoom();
